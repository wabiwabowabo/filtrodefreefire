...
barba = loadImage('https://i.postimg.cc/6515sSrG/barba-del-viejo-free-fire-png-one.png');
gorro = loadImage('https://i.postimg.cc/P5YWPmrK/Daco-6028608.png');
}
...
function draw() {
  ...
  image(barba, noseX, noseY, 40, 40)
  image(gorro, left_eyeX, left_eyeY, 100, 100)
}
